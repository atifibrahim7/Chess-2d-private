...
public:
        ...
        : board(bordCol1, bordCol2)
    {
        ...
        textBackground.setFillColor(sf::Color(0xF5F5DCFF)); // Beige color
        textBackground.setPosition(sf::Vector2f(512.f, 0.f));
        textBackground.setSize(sf::Vector2f(256.f, 512.f));
        ...
        textTurn.setFillColor(sf::Color::Black);
        ...
        textSituation.setFillColor(sf::Color::Black);
        ...
        textLastMove.setFillColor(sf::Color::Black);
